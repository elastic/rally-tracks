...
#    --track-params="number_of_replicas:0,snapshot_bucket:${SNAPSHOT_BUCKET},snapshot_name:logging-test,snapshot_base_path:observability/logging-integration-tests" \
