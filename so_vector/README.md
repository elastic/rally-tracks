...
* `esql_profiling_enabled` (default: false) : Controls if ESQL benchmarks are profiled.
* `esql_retrieve_source` (default: false) : True to retrieve _source in the ESQL query instead of the individual fields.
