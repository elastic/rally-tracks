...
* `index_sorting` (default: unset): Whether index sorting should be used. Accepted values: `hostnams` and `timestamp`. Setting index sorting also enabled synthetic source.
