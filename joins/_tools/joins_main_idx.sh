...
for ((id = 0; id<ndocs; id++)); do
  ...
  echo -n ', "key_1_000": "'$((id%1000))'"'
  echo -n ', "key_100_000": "'$((id%100000))'"'
  echo -n ', "key_200_000": "'$((id%200000))'"'
  echo -n ', "key_500_000": "'$((id%500000))'"'
  echo -n ', "key_1_000_000": "'$((id%1000000))'"'
  echo -n ', "key_5_000_000": "'$((id%5000000))'"'
  echo -n ', "key_100_000_000": "'$((id%100000000))'"'
  for ((i = 0; i<100; i++)); do
