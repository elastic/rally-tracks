...
* `pattern_text_message_field` (default: `false`) - If true use `pattern_text` for all message fields, else `match_only_text`. 
* `pattern_text_index_options` (default: `docs`) - If set to `positions`, includes positions in the pattern_text message field index.
